...
print ("Alexander Olvera Modified This Credit Card Validator")
...
def run_tests():
    ...
    assert  is_credit_card_valid("000000000000"), 'This is a bad test and we will get an error message'
